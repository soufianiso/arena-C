...
static void test_alignment(void) {
    ...
    printf("ptr1: %p (aligned: %s)\n", ptr1, ((uintptr_t)ptr1 % ARENA_ALIGNMENT == 0) ? "yes" : "no");
    printf("ptr2: %p (aligned: %s)\n", ptr2, ((uintptr_t)ptr2 % ARENA_ALIGNMENT == 0) ? "yes" : "no");
    printf("ptr3: %p (aligned: %s)\n", ptr3, ((uintptr_t)ptr3 % ARENA_ALIGNMENT == 0) ? "yes" : "no");
    printf("ptr4: %p (aligned: %s)\n", ptr4, ((uintptr_t)ptr4 % ARENA_ALIGNMENT == 0) ? "yes" : "no");
